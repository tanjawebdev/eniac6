export const INTRO_STEPS = [
  {
    id: 'title', label: 'The ENIAC 6', eyebrow: 'Six women. A new language of possibility.',
    title: 'THE ENIAC 6',
    body: 'The story of six women who programmed the first electronic general-purpose computer.',
    duration: 9000,
  },
  {
    id: 'context', label: 'A world at war', eyebrow: 'United States · World War II',
  ...
  {
    id: 'machine', label: 'The machine', eyebrow: 'ENIAC · Publicly unveiled in 1946',
    title: 'A whole room.\nA new way to compute.',
    body: 'Built to calculate artillery firing tables, ENIAC was the first electronic general-purpose digital computer. Its programmers translated calculations into sequences of operations, connecting cables and setting switches by hand.',
    note: 'Electronic Numerical Integrator and Computer',
    duration: 19000,
  },
  {
    id: 'recognition', label: 'Their place in history', eyebrow: 'Pioneering work · Belated recognition',
  ...
  {
    id: 'insert', label: 'Choose a woman', eyebrow: 'Your turn · 01 / 03',
    title: 'One punched card.\nOne woman’s story.',
    body: 'Each punched card represents the woman named on it. Choose a card and insert it into a slot in the box.',
    note: 'Start with any woman. There is no fixed order.',
    duration: 13000,
  },
  {
    id: 'connect', label: 'Connect a chapter', eyebrow: 'Your turn · 02 / 03',
  ...
  {
    id: 'controls', label: 'Shape the experience', eyebrow: 'Your turn · 03 / 03',
    title: 'Turn the controls.\nSee your changes come alive.',
    body: 'Use the controls in your chosen chapter to change the animation in real time. Experiment with the parameters and see how each adjustment changes what the code creates.',
    note: 'Inspired by the women’s hands-on approach to programming. Choose a card to begin.',
    duration: 17000,
  },
] as const;
